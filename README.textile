...
This fork should hopefully make it a bit more Rails 3 compatible, by moving the task to the lib/tasks folder and renaming the file to delayed_delta.rake.
